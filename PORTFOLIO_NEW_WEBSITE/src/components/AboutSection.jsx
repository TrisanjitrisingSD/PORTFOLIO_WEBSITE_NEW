        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Web Developer & Data Science and AI/ML Enthusiast
            </h3>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Uncovering insights from data to drive intelligent, impactful decisions and
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Exploring intelligent systems that learn, adapt, and solve real-world challenges and
                    learning how to implement AI for betterment.
                  </p>
                </div>
              </div>
            </div>
